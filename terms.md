...
You must be at least **16 years old** to use GifChat. By using the app, you confirm that you meet this age requirement. If we learn that a user is under the minimum age, we may terminate their account.

## 3. Your Account

- You are responsible for maintaining the confidentiality of your account credentials and for all activity under your account.
- You agree to provide accurate information when creating your account.
- You may not impersonate others, create accounts for abusive purposes, or share your account in ways that violate these Terms.
- You can delete your account at any time from within the app.

## 4. How GifChat Works (AI Processing)

GifChat uses artificial intelligence to turn your text into reaction GIFs. To provide this, the content you type — including messages and conversation context — is processed by third-party AI providers (OpenAI and Anthropic). By using GifChat's messaging and GIF features, you acknowledge and agree to this processing, as described in our Privacy Policy.

## 5. User Content

**Your content:** You retain ownership of the content you create and share on GifChat (your posts, messages, comments, captions, and other contributions, collectively "User Content").

**License you grant us:** By posting User Content, you grant us a non-exclusive, worldwide, royalty-free license to host, store, display, reproduce, and distribute that content **solely for the purpose of operating and providing the app** (for example, showing your posts in feeds, delivering your messages, and displaying your stories). This license ends when you delete the content or your account, except where the content has been shared with others or is retained in anonymized form as described in our Privacy Policy.
...
- Post or share content that is illegal, harmful, threatening, abusive, harassing, defamatory, hateful, or that incites violence.
- Post sexually explicit content, content involving minors, or any content that exploits or endangers children.
- Harass, bully, intimidate, stalk, or threaten other users.
